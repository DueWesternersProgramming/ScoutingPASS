...
function updateQRHeader() {
  let str = 'Event: !EVENT! Match: !MATCH! Robot: !ROBOT! Team: !TEAM!<br>Make sure to Screenshot or scan this code!';
  ...
  if (!pitScouting) {
    ...
    str = 'Pit Scouting - Team !TEAM!<br>Make sure to Screenshot or scan this code!'
      .replace('!TEAM!', document.getElementById("input_t").value);
  }
